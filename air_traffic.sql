...
CREATE TABLE flights (
  ...
  to_country INT REFERENCES countries(id) ON DELETE CASCADE
  );
...
(
  ...
  airline INTEGER REFERENCES airlines(id) ON DELETE CASCADE,
  flight INT REFERENCES flights ON DELETE CASCADE
);
...
INSERT INTO flights (airline, from_city, from_country, to_city, to_country) VALUES
(1, 'Washington DC', 1, 'Seattle', 1),
(2, 'Tokyo', 2, 'London', 3),
(3, 'Los Angeles', 1, 'Las Vegas', 1),
(3, 'Seattle', 1, 'Mexico City', 4),
(4, 'Paris', 5, 'Casablanca', 6),
(5, 'Dubai', 7, 'Beijing', 8),
(1, 'New York', 1, 'Charlotte', 1),
(6, 'Cedar Rapids', 1, 'Chicago', 1),
(6, 'Charlotte', 1, 'New Orleans', 1),
(7, 'Sao Paolo', 9, 'Santiago', 10);


INSERT INTO tickets
  (first_name, last_name, seat, departure, arrival, airline, flight)
VALUES
